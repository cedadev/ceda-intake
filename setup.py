...
from ceda_intake import __version__ as _package_version
...
setup(
    ...
    description="Generate Intake ESM catalogs",
    ...
    entry_points={
        'console_scripts': [
            'ceda_intake=ceda_intake.cli:main',
        ],
    },
    ...
    keywords='ceda_intake',
    name='ceda_intake',
    packages=find_packages(include=['ceda_intake']),
    setup_requires=setup_requirements,
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/cedadev/ceda_intake',
